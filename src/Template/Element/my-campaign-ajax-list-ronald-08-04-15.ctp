...
<div class="row my-campaigns-dynamic-area">
	...
	<div class="col-sm-12">
		<div class="well">
			...
			<div class="col-sm-12"><!-- Top 5 deals league table -->


				<div class="row table-title">

					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<h2><?= __('Top 5 deals'); ?> <small><?= $this->Html->link(__('See all'), ['controller' => 'CampaignPartnerMailinglists','action' => 'listdeals']); ?></small></h2>
					</div>

					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<btn class="pull-right btn btn-priamry">
							<?= $this->Html->link(__('Register a deal'), '#',['onclick'=>'movemailinglist();']); ?>
						</btn>
					</div>
			...
			<div class="col-sm-12"><!-- Timeline -->
				...
				<div class="col-sm-12">
					...
					<?php if (!empty($campaigndetails->campaign_resources)): ?>
...
<?php // echo 'TEST'.$conversiondata['open']; ?>


<!-- Initialize Timeline -->
<script>
$('.timelineFlat').timeline({
	openTriggerClass : '.read_more',
	startItem : '<?= date("d/m/Y");?>',
	swipeOn : false,
...
var doughnutData = [
{
	value: <?= $conversiondata['open']; ?>,
	color: "#FFAC00",
	highlight: "#FFD022",
	label: "Opens"
},
{
	value: <?= $conversiondata['click']; ?>,
	color: "#AD0061",
	highlight: "#C04668",
	label: "Clicks"
},
{
	value: <?= $conversiondata['unsubscribe']; ?>,
	color: "#57968F",
	highlight: "#5AD3D1",
	label: "Unsubscribes"
},
{
	value: <?= $conversiondata['bounce']; ?>,
	color:"#867C04",
	highlight: "#969B1E",
	label: "Bounced"
},
...
//window.onload = function(){
	...
	var myDoughnut = new Chart(ctx).Doughnut(doughnutData, {
		...
		legendTemplate : "<div class=\"col-sm-6 col-xs-6\"><ul class=\"<%=name.toLowerCase()%>-legend\"><% for (var i=0; i<segments.length; i++){%><li><span style=\"background-color:<%=segments[i].fillColor%>\"></span><%=segments[i].value%> <%if(segments[i].label){%><%=segments[i].label%><%}%></li><%}%></ul></div>"
	}
	);
...
myDoughnut.chart.canvas.parentNode.parentNode.parentNode.appendChild(legendHolder.firstChild);	

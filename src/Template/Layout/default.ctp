...
<!--[if gt IE 8]><!--> <html>         <!--<![endif]-->
	...
	<body
		...
		?>
	onload="_googWcmGet(callback, '+44 1628 564920')">
					...
					<div class="row">
						<div class="navbar-header">
							...
							<div class="contact-details">
								<a href="tel:+441628566000" title="<?= __('Call us on +44 1628 564 920')?>" id="contact-tel" class="contact-tel">+44 1628 564 920</a>

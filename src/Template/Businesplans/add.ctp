	...
	<div class="row table-title partner-table-title">
		...
		<div class="partner-sub-menu clearfix">
			...
			<div class="col-md-4 col-sm-6">
				<?php echo $this->Form->input('financialquarter_id', ['options' => $financialquarters, 'value'=> $fqid ,'data-live-search' => true]);?>
			</div>
			
			<div class="col-md-4 col-sm-6" id="campaigngroups">
...
<div class="campaigns form col-centered col-lg-10 col-md-10 col-sm-10">
  ...
  <?php echo $this->Flash->render(); echo $this->Flash->render('auth'); ?>
	...
	<div class="row inner header-row">
		...
		<dd class="col-lg-3 col-md-4 col-sm-6 col-xs-8">
			<div class="btn-group pull-right">
	            <?= $this->Html->link(__('Edit your details'), ['controller'=>'Partners','action' => 'edit', $partner->id,'bplan'],['class' => 'btn pull-right']); ?> 
			</div>
		</dd>
	</div>
	...
	<fieldset>
     ...
     <!--<div id="reqamt">
	     <?php //echo $this->Form->input('required_amount',['value'=>0,'readOnly'=>true]);?>
	   </div>-->
		<?php
			echo $this->Form->input('target_geography');
			echo $this->Form->input('expected_result');
			//echo $this->Form->input('expected_roi',['value'=>0]);

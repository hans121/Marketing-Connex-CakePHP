		...
		<div class="col-md-5 col-sm-4 col-xs-6">
			...
			<div class="breadcrumbs">
				<?php
					...
					$this->Html->addCrumb('Search results', ['controller' => 'Resources', 'action' => 'search']);
   ...
   <?= $this->Form->checkbox('bulkid[]',['class'=>'css-checkbox bulk-selector','value'=>$resource->id,'label'=>false,'id'=>'bulkid-'.$resource->id])?>
	...
	<div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
		...
		<div class="btn-group pull-right">
			...
			<?= $this->Html->link(__('Edit'), ['controller'=>'Resources','action' => 'edit',$resource->folder_id, $resource->id],['class' => 'btn pull-right']); ?>

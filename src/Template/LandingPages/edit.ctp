	...
	<fieldset>
			...
			<div class="col-md-9">
				...
				<div class="breadcrumbs">
					<?php
						...
						$this->Html->addCrumb('edit', ['controller' => 'LandingPages', 'action' => 'edit', $campaign->id]);
		...
		<div class="row form-inner">
			...
			<div id="toggle-width" class="col-lg-9 col-md-9 col-sm-7 col-xs-12 pull-left">
				...
				<div class="badge badge-blue badge-large">1</div>
			    ...
			    <div class="resource-selector">
				    <div class="file-wrapper">
				    	<div class="input file">
								<?= $this->Form->input('banner_bg_image',['type'=>'file']);?>
				    	</div>
          ...
          */
          echo $this->Form->input('ajaxedit_id',['value'=>$landingPage->id,'type'=>'hidden']);
				?>
				
				</div>
				
				<div class="badge badge-blue badge-large">2</div>
				...
				<div class="hover-area3">
					<div class="badge badge-blue badge-large">3</div>
					...
					?>
					<!--
				    <label><?= __('Downloadable item')?></label>
				    <div class="resource-selector">
					    <div class="file-wrapper">
					    	<div class="input file">
							    <input type="file" name="downloadable_item" data-toggle="collapse" data-target="#collapseFormSubmit">
					    	</div>
					    	<span class="btn pull-right button">Choose</span>
					    </div>
				    </div>
  		    ...
  		    <!-- Jasny Bootstrap input[type='file'] styling -->  
				...
				<div class="hover-area4">
					...
					<div class="badge badge-blue badge-large">4</div>
				...
				<div class="hover-area5">
					...
					<div class="badge badge-blue badge-large">5</div>
      ...
      <div class="modal-body">
	      <div class="intrinsic-container intrinsic-container-4x3">
		      <iframe src="#" id="previewbrowser" allowfullscreen>
						<!-- Dynamically populate this area with the landing page content, via the ID -->
		      </iframe>
	      </div>
      </div>

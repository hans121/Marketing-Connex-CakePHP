<div class="vendorManagers form">
  ...
  <?php echo $this->Flash->render(); echo $this->Flash->render('auth'); ?>
	...
	<fieldset>
		...
		<legend><?= __('Edit Vendor Manager'); ?></legend>
...
<div class="actions">
	...
	<ul>
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $vendorManager->id], ['confirm' => __('Are you sure you want to delete # %s?', $vendorManager->id)]); ?></li>

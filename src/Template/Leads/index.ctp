            ...
            <div class="card">
                <div class="card--header">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="card--info">
                                ...
                                <h3 class="card--subtitle">Active Marketing Leads <?= $this->Html->link(__('view inactive'), ['action' => 'inactive']); ?></h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>Here is a breakdown of your active marketing leads, highlighting which partners are working on these and when they were assigned.
                                </p>
                                <hr>
                            </div>
                        </div>

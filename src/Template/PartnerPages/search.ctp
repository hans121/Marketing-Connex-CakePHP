			...
			<div class="breadcrumbs">
				<?php
					...
					if($parentmenu->parent_id!=0) : // not root menu, add the parent folder to the breadcrumb
						$this->Html->addCrumb( h($page->title), ['controller' => 'PartnerPages', 'action' => 'view', $parentmenu->id, $page->id]);
					endif;

					$this->Html->addCrumb( h($page->title), ['controller' => 'PartnerPages', 'action' => 'view', $page->id]);
...
<div class="row inner">
	...
	<div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
		<i class="fa fa-file-o fa-lg"></i> <?= $this->Html->link(h($page->title), ['controller'=>'PartnerPages','action' => 'view', $page->id]); ?>
	</div>

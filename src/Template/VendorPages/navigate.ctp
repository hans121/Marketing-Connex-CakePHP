...
<div class="row table-title partner-table-title">
	...
	<div class="partner-sub-menu clearfix">
        ...
        <?= $this->Html->link(__('Add menu'), ['controller'=>'VendorMenus','action' => 'add', $parentmenu->id],['class' => 'btn btn-lg pull-right']); ?>
...
<div class="row inner">
	...
	<div class="col-md-4 col-sm-5 hidden-xs">
				<?= $this->Html->link(__('Delete'), ['controller'=>'VendorMenus','action'=>'delete',$parentmenu->parent_id,$parentmenu->id],['confirm' => __('Are you sure you want to delete this menu?'),'class' => 'btn btn-danger pull-right']); ?>
		    	<?= $this->Html->link(__('Edit'), ['controller' => 'VendorMenus', 'action' => 'edit',$parentmenu->parent_id, $parentmenu->id],['class' => 'btn pull-right']); ?>
		    	<?= $this->Html->link(__('Rename'), ['controller' => 'VendorMenus','action' => 'rename', $parentmenu->id],['class' => 'btn pull-right','onclick'=>'return renamemenu('.$parentmenu->id.',"'.$parentmenu->name.'")']); ?>
	</div>
	<?php
	else:
	?>
...
?>
		...
		<div class="row inner">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<?= $this->Html->link(__('Delete'), ['controller'=>'VendorMenus','action'=>'delete',$menu->parent_id,$menu->id],['confirm' => __('Are you sure you want to delete this menu?'),'class' => 'btn btn-danger pull-right']); ?>
		    	<?= $this->Html->link(__('Edit'), ['controller' => 'VendorMenus', 'action' => 'edit',$menu->parent_id, $menu->id],['class' => 'btn pull-right']); ?>
		    	<?= $this->Html->link(__('Rename'), ['controller' => 'VendorMenus','action' => 'rename', $menu->id],['class' => 'btn pull-right','onclick'=>'return renamemenu('.$menu->id.',"'.$menu->name.'")']); ?>
		  	</div>
   ...
   <?= $this->Form->checkbox('bulkid[]',['class'=>'css-checkbox bulk-selector','value'=>$page->id,'label'=>false,'id'=>'bulkid-'.$page->id])?>
	...
	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
		...
		<div class="btn-group pull-right">
			...
			<?= $this->Html->link(__('View'), ['controller'=>'VendorPages','action' => 'view', $page->id],['class' => 'btn pull-right']); ?>

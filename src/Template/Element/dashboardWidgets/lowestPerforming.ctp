...
<button type="button" class="close pull-right" data-toggle="collapse" data-target="#collapseLowestPerforming"><i class="icon icon--small ion-minus-circled"></i></button>

                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="card--icon">
                                <div class="bubble">
                                    <i class="icon ion-arrow-graph-down-left"></i></div>
                            </div>
                            <div class="card--info">
                                <h2 class="card--title"><?= __('Lowest performing partners'); ?></h2>
                                <h3 class="card--subtitle">Snapshot of your 5 Lowest Earning Partners</h3>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6">
                            <div class="card--actions">
                                <?= $this->Html->link(__('View all'), ['controller' => 'Vendors','action' => 'Partners'], ['class' => 'btn btn-primary pull-right']); ?>
                                                ...
                                                <div class="collapse in" id="collapseLowestPerforming">

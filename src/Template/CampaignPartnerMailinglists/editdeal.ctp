...
<div class="row table-title partner-table-title">
		...
		<div class="col-md-5 col-sm-5">
			...
			<div class="breadcrumbs">
				<?php
					...
					$this->Html->addCrumb('edit', ['controller' => 'CampaignPartnerMailinglists', 'action' => 'edit']);
	...
	<div class="partnerManagers form col-centered col-lg-10 col-md-10 col-sm-10">
		...
		<?php 
		//$campaignPartnerMailinglistDeal->closure_date = date('d/m/Y',strtotime($campaignPartnerMailinglistDeal->closure_date));
		?>
		...
		echo $this->Form->input('status', ['type'=>'select','label'=>'Deal Status','options'=>[ 'Y' => 'Close', 'N' => 'Pending' ]]);
		?>
	  ...
	  <div id="closuredate" style="display: none;">
	  	<?php echo $this->CustomForm->date('closure_date',$campaignPartnerMailinglistDeal->closure_date,'Closure Date'); ?>
	  </div>

		<?php
		echo $this->Form->hidden('campaign_partner_mailinglist_id');
		?>

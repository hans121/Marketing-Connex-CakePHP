<div class="Campaignplans vendors">
  ...
  <div class="row table-title">
		...
		<div class="col-sm-8">
			...
			<h2><?= __('Campaign Plans')?><small><?= $this->Html->link(__('See all'), ['controller' => 'Campaignplans','action' => 'index']); ?></small></h2>
			<div class="breadcrumbs">
				<?php
					$this->Html->addCrumb('Campaign Plans', ['controller' => 'Campaignplans', 'action' => 'index']);
					$this->Html->addCrumb('view', ['controller' => 'Campaignplans', 'action' => 'view', $businesplan->id]);
		...
		<div class="col-sm-4">
	        ...
	        <?= $this->Html->link(__('Add new'), ['controller' => 'Campaignplans', 'action' => 'add'],['class'=>'btn btn-lg pull-right']); ?>
			</div>
		</div>
	...
	<div class="row inner header-row ">
		...
		<dd class="col-lg-3 col-md-4 col-sm-6 col-xs-4">
	      ...
	      <?php if($businesplan->status == 'Draft'):
					echo $this->Html->link(__('Edit'), ['controller' => 'Campaignplans','action' => 'edit', $businesplan->id],['class' => 'btn pull-right']);
	      endif;
	      ?>
			</div>
		</dd>

<div class="folders view">
	...
	<div class="row table-title">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			...
			<div class="breadcrumbs">
				<?php
					...
					$this->Html->addCrumb('View resource', ['controller' => 'Resources', 'action' => 'view', $resource->id]);
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	    <?= $this->Html->link(__('Add resource'), ['action' => 'add', 1],['class'=>'btn btn-lg pull-right']); ?>
		</div>
  ...
  <div class="row inner header-row ">
    ...
    <dt class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
      ...
      <i class="fa fa-folder-open-o"></i>          
		...
		<dd class="col-lg-3 col-md-3 col-sm-3 hidden-xs">
			<?= $resource->has('folder') ? $this->Html->link(__('Edit'), ['controller' => 'Folders', 'action' => 'edit', $resource->folder->id],['class'=>'btn pull-right']) : '' ?>
			<?= $resource->has('folder') ? $this->Html->link(__('View'), ['controller' => 'Folders', 'action' => 'view', $resource->folder->id],['class'=>'btn pull-right']) : '' ?>
		</dd>
	</div>
    ...
    <dt class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
		...
		<dd class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
			<?= $resource->has('user') ? $resource->user->title.' '.$resource->user->first_name : '' ?>
			&nbsp;
		</dd>
	</div>

		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			...
			<div class="breadcrumbs">
				<?php
					...
					$this->Html->addCrumb('View folder', ['controller' => 'Folders', 'action' => 'view']);
  ...
  <?php echo $this->Flash->render(); echo $this->Flash->render('auth'); ?>
	...
	<div class="row inner header-row ">
		...
		<dd class="col-lg-3 col-md-4 col-sm-6 col-xs-8">
			...
			<?= $this->Html->link(__('Edit'), ['action' => 'edit', $folder->id],['class' => 'btn pull-right']); ?>
		</dd>
	</div>
      ...
      <i class="fa fa-folder-open-o"></i>          
		...
		<dd class="col-sm-2 hidden-xs">
			<?php
				...
				echo $this->Html->link(__('View parent'), ['controller' => 'Folders', 'action' => 'view', $folder->parent_id],['class'=>'btn pull-right']);
				}
			?>
		</dd>
	</div>
    ...
    <dt class="col-xs-5">
		...
		<dd class="col-xs-7">
			<?= $folder->has('user') ? $folder->user->title.' '.$folder->user->first_name : __('Not assigned') ?>
			&nbsp;
		</dd>
	</div>

					...
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<div class="card--icon">
								...
								<div class="card--info">
									<h2 class="card--title"><?= __('Browser and Spam checker'); ?></h2>
									<h3 class="card--subtitle">Template QA Testing</h3>
								</div>
							</div>
							<div class="col-xs-12 col-md-6">
									...
									<div class="panel-body" style="minimum-height: 750px;">
										<div class="row" id="spamcheckprogress">
											...
											<div class="col-xs-10 col-xs-offset-1">
												...
												<h4 class="text-center"><?= __('Please wait while we process your template...'); ?></h4>

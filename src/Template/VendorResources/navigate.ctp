<script>
	...
	function renamefolder(folder_id, folder_name){
		...
		$.ajax ({
			type: "POST",
			url: "<?php echo $this->Url->build([ "controller" => "VendorFolders","action" => "rename"],true);?>",
			data: dataString,
			cache: false,
...
<div class="row table-title partner-table-title">
	...
	<div class="partner-sub-menu clearfix">
        ...
        <?= $this->Html->link(__('Add folder'), ['controller'=>'VendorFolders','action' => 'add', $parentfolder->id],['class' => 'btn btn-lg pull-right']); ?>
...
<div class="row inner">
	...
	<div class="col-md-4 col-sm-5 hidden-xs">
		<?= $this->Html->link(__('Delete'), ['controller'=>'VendorFolders','action'=>'delete',$parentfolder->parent_id,$parentfolder->id],['confirm' => __('Are you sure you want to delete this folder?'),'class' => 'btn btn-danger pull-right']); ?>
  	<?= $this->Html->link(__('Edit'), ['controller' => 'VendorFolders', 'action' => 'edit', $parentfolder->id],['class' => 'btn pull-right']); ?>
  	<?= $this->Html->link(__('View'), ['controller' => 'VendorFolders', 'action' => 'view', $parentfolder->id],['class' => 'btn pull-right']) ?>
...
?>
		...
		<div class="row inner">
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<i class="fa fa-folder-o fa-lg"><?= $this->Html->link('', ['controller' => 'VendorResources', 'action' => 'navigate', $folder->id]) ?></i> <?= $this->Html->link($folder->name, ['controller' => 'VendorResources', 'action' => 'navigate', $folder->id]) ?>
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<?= $this->Html->link(__('Delete'), ['controller'=>'VendorFolders','action'=>'delete',$folder->parent_id,$folder->id],['confirm' => __('Are you sure you want to delete this folder?'),'class' => 'btn btn-danger pull-right']); ?>
	    	<?= $this->Html->link(__('Edit'), ['controller' => 'VendorFolders', 'action' => 'edit', $folder->id],['class' => 'btn pull-right']); ?>
	    	<?= $this->Html->link(__('View'), ['controller' => 'VendorFolders', 'action' => 'view', $folder->id],['class' => 'btn pull-right']) ?>
...
<div class="row inner hidden-xs">
   ...
   <?= $this->Form->checkbox('bulkid[]',['class'=>'css-checkbox bulk-selector','value'=>$resource->id,'label'=>false,'id'=>'bulkid-'.$resource->id])?>
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
		<i class="fa fa-file-o fa-lg"></i> <?= $this->Html->link(h($resource->name), ['controller'=>'VendorResources','action' => 'view', $resource->id]); ?>
	</div>
	...
	<div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
		...
		<div class="btn-group pull-right">
			...
			<?= $this->Html->link(__('Edit'), ['controller'=>'VendorResources','action' => 'edit',$parentfolder->id, $resource->id],['class' => 'btn pull-right']); ?>
		...
		<div class="row inner">
			...
			<div class="col-xs-12">
				...
				<div class="btn-group pull-right">
					...
					<?= $this->Html->link(__('Edit'), ['controller'=>'VendorResources','action' => 'edit', $resource->id],['class' => 'btn pull-right']); ?>
					<?= $this->Html->link(__('View'), ['controller'=>'VendorResources','action' => 'view', $resource->id],['class' => 'btn pull-right']); ?>

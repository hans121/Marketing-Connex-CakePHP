<div class="folder view">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			...
			<div class="breadcrumbs">
				<?php
					...
					$this->Html->addCrumb('view folder', ['controller' => 'PartnerFolders', 'action' => 'view', $folder->id]);
  ...
  <?php echo $this->Flash->render(); echo $this->Flash->render('auth'); ?>
      ...
      <i class="fa fa-folder-open-o"></i>          
		...
		<dd class="col-sm-2 hidden-xs">
			<?php
				...
				echo $this->Html->link(__('View parent'), ['controller' => 'PartnerFolders', 'action' => 'view', $folder->parent_id],['class'=>'btn pull-right']);
				}
			?>
		</dd>
	</div>
    ...
    <dt class="col-xs-5">
		...
		<dd class="col-xs-7">
			<?= $folder->has('vendor') ? $folder->vendor->company_name : __('Not assigned') ?>
		</dd>
	</div>
 ...
 */?>
  ...
  <div class="row related">
		<div class="col-lg-9 col-md-8 col-sm-6 col-xs-8">
			<h3><?= __('Related Resources')?><small><?= $this->Html->link(__('View all'), ['controller' => 'PartnerResources', 'action' => 'index'],['title'=>'View all Vendors']); ?></small></h3>
		</div>
  ...
  <div class="row inner hidden-xs">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4">
			<?= $this->Html->link(__('View'), ['controller'=>'PartnerResources','action' => 'view', $resources->id],['class' => 'btn pull-right']); ?>
			<?= $this->Html->link(__('Download'), ['controller'=>'PartnerResources','action' => 'download', $resources->id],['class' => 'btn pull-right']); ?>
    </div>
	...
	<div class="row inner filetree visible-xs">
		...
		<div id="coupons-<?=$j?>" class="col-xs-12 panel-collapse collapse">
			...
			<div class="row inner">
				<div class="col-xs-12">
					<?= $this->Form->postLink(__('Download'), ['controller'=>'PartnerResources','action' => 'downloadfile', $resources->id], ['class' => 'btn pull-right']); ?>
				</div>
			</div>
